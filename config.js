...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~xc5ykAzS#LiQMfrQdBntPuvuncYiTGvyNtxO51ihau3-1cvcJKIU",  // Your bot's session ID (keep it secure)
    ...
    DEV: process.env.DEV || "243994158410",                     // Developer's contact number
    
    // ===== AUTO-RESPONSE SETTINGS =====
    
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "false",// Reply to status updates?
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*TERMUX-BOT VIEWED YOUR STATUS 🤖*",  // Status reply message
